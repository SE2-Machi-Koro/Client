...
class WebSocketContractTest {
    ...
    fun matchesCurrentServerEndpointAndDestinationSetup() {
        ...
        assertEquals("/app/game.advancePhase", WebSocketContract.advancePhaseDestination)
        assertEquals("/app/game.resolveEffects", WebSocketContract.resolveEffectsDestination)
        assertEquals("/app/game.endTurn", WebSocketContract.endTurnDestination)
